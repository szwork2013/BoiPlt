...
{
    [Binding]
    public class DocumentGenerateEntityMigrationMultipleDatabaseContextsSteps
    {
        ...
        [When(@"I enter page reference GenerateEntityMigrationMultipleDatabaseContexts ""(.*)""")]
        public void WhenIEnterPageReferenceGenerateEntityMigrationMultipleDatabaseContexts(string p0)
        {
            DriverHelper.NavigateToDocumentationUrl(p0);
        }
        [Then(@"I should see the documentation on how to add migration for a database context ""(.*)""")]
        public void ThenIShouldSeeTheDocumentationOnHowToAddMigrationForADatabaseContext(string p1)
        {
